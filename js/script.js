...
(function() {
	...
	URLs.readme = 'https://api.github.com/repos/doc-metrix/general/contents/README.md';
	URLs.markdown = 'https://api.github.com/markdown';
	URLs.spec = 'https://api.github.com/repos/doc-metrix/general/contents/spec/index.json';

	CONTEXT = 'doc-metrix/general';
